...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=C9D1D9&center=true&vCenter=true&width=600&lines=Konstantin+Suprun+%2F+aevar;System+Architect+%26+Developer;Moscow%2C+Russia" alt="Typing SVG" />
...
| Area | Focus | Tech Stack |
|------|-------|------------|
| **System Architecture** | High-performance tools & Desktop software | Rust, Tauri, PyO3, Go |
| **AI Infrastructure** | Local LLM Inference & RAG Pipelines | DeepSeek, Llama, FAISS, LangChain |
| **Backend & DevOps** | Scalable microservices & Automation | FastAPI, PostgreSQL, Docker, Redis |
| **Network & Security** | Secure routing & Protocol optimization | VPN/Proxy, VLESS, Linux Kernel |
...
![LLM](https://img.shields.io/badge/Local_LLM-4a4a4a?style=flat-square)
![RAG](https://img.shields.io/badge/RAG_Systems-FFD21E?style=flat-square)
![VectorDB](https://img.shields.io/badge/Vector_DB-0866FF?style=flat-square)
![Cursor](https://img.shields.io/badge/Cursor_AI-5C3EE8?style=flat-square)
...
*Building secure systems and intelligent agents · Open to architecture-heavy collaborations*
